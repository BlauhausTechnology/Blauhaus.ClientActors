...
namespace Blauhaus.ClientActors.TestHelpers.Extensions
{
    public static class MockContainerExtensions
    {
        ...
        public static Func<ModelActorContainerMockBuilder<TActor, TId, TModel>> AdMockModelActorContainer<TActor, TId, TModel>(this MockContainer mocks) where TActor : class, IModelActor<TId, TModel> where TModel : IId<TId>
        {
